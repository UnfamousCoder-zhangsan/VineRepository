...
- (void)initSubviews {
    ...
    [self.sendButton setTitle:self.sendButtonText.length>0?self.sendButtonText:@"发送" forState:UIControlStateNormal];
    ...
    if (self.shouldUseOriginImage) {
        ...
        [self.originImageCheckboxButton setImage:[UIImageMake(@"origin_image_checkbox") qmui_imageWithTintColor:UIColorMakeWithHex(@"#1AC095")] forState:UIControlStateNormal];
        [self.originImageCheckboxButton setImage:[UIImageMake(@"origin_image_checkbox_checked") qmui_imageWithTintColor:UIColorMakeWithHex(@"#1AC095")] forState:UIControlStateSelected];
        [self.originImageCheckboxButton setImage:[UIImageMake(@"origin_image_checkbox_checked") qmui_imageWithTintColor:UIColorMakeWithHex(@"#1AC095")] forState:UIControlStateSelected|UIControlStateHighlighted];
