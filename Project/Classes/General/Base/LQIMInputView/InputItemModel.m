...
+(instancetype)initWithTitle:(NSString *)title imageName:(NSString *)imageName type:(InputItemModelType)inputItemModelType clickedBlock:(ItemClicked)clickedBlock{
    InputItemModel *model = [[InputItemModel alloc] initWithTitle:title imageName:imageName clickedBlock:clickedBlock];
    model.inputItemModelType = inputItemModelType;
    return model;
}
@end
