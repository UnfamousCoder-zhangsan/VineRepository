...
#import "KB_BaseTableViewController.h"

@interface KB_BaseTableViewController ()
...
@implementation KB_BaseTableViewController
...
- (void)viewDidLoad {
    ...
    if (self.shouldLoadData) {
        ...
        [self.loadingView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.top.equalTo(self.tableView).offset(40);
...
- (UIImageView *)loadingView {
    if (!_loadingView) {
        ...
        for (NSInteger i = 0; i < 4; i++) {
            ...
            UIImage *img = [self changeImageWithImage:[UIImage imageNamed:imageName] color:UIColorMakeWithHex(@"#888888")];
