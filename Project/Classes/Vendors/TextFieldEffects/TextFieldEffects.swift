...
open class TextFieldEffects: UITextField {
    ...
    open override func drawPlaceholder(in _: CGRect) {
    ...
    open override func willMove(toSuperview newSuperview: UIView!) {
        if newSuperview != nil {
            NotificationCenter.default.addObserver(self, selector: #selector(textFieldDidEndEditing), name: NSNotification.Name(rawValue: "UITextFieldTextDidEndEditing"), object: self)

            NotificationCenter.default.addObserver(self, selector: #selector(textFieldDidBeginEditing), name: NSNotification.Name(rawValue: "UITextFieldTextDidBeginEditing"), object: self)
        } else {
